<?php /* Smarty version 2.6.20, created on 2017-05-08 15:03:23
         compiled from D:%5Cphpstudy%5CWWW%5Cerp_wms%5Capplication%5Ctemplates/sp/package3_order_list.htm */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'site_url', 'D:\\phpstudy\\WWW\\erp_wms\\application\\templates/sp/package3_order_list.htm', 217, false),)), $this); ?>
...
<script>
    ...
    var checkchange = function()
    {
        $('.df_submit').bind('click',function()
        {
            ...
            $.post('<?php echo ((is_array($_tmp='package3/package_fedex_pakge_id')) ? $this->_run_mod_handler('site_url', true, $_tmp) : site_url($_tmp)); ?>
