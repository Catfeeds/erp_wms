<?php /* Smarty version 2.6.20, created on 2016-12-29 17:28:57
         compiled from package_add4.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'site_url', 'package_add4.html', 97, false),)), $this); ?>
                    ...
                    <form action=""  class="form-horizontal" method="post"  id='form_1' enctype="multipart/form-data">
                        ...
                        <div class="row-fluid" style="margin-top:20px;">
                            <div class="control-group">
                                <label class="control-label span2">港口<span class="required">*</span></label>
                                <div class="span7" >
...
" data-date-format="yyyy-mm-dd" data-date-viewmode="years">
                                        <input name="flight_date" class="m-wrap m-ctrl-medium date-picker" type="text"  >
...
?fedex_model=3',form1.serialize(),function(msg){
                //alert(msg);
                try
                {
                    eval("var str="+msg);
