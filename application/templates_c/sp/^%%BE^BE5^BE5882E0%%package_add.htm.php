<?php /* Smarty version 2.6.20, created on 2017-02-13 15:40:02
         compiled from package_add.htm */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'site_url', 'package_add.htm', 111, false),)), $this); ?>
            ...
            <div class="row-fluid" style="margin-top:10px;">
              <div class="control-group">
                ...
                <div class="controls span6 ">
                  <select name="fedex_type" id="fedex_type">
              ...
              <div class="control-group">
                ...
                <div class="span7" >
                  <div class="input-append date date-picker"  data-date-format="yyyy-mm-dd" data-date-viewmode="years">
                    <input name="ship_timestamp" class="m-wrap m-ctrl-medium date-picker" type="text" >
