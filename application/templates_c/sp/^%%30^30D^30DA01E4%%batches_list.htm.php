<?php /* Smarty version 2.6.20, created on 2017-03-29 09:29:28
         compiled from batches_list.htm */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'site_url', 'batches_list.htm', 122, false),)), $this); ?>
            ...
            <tr>
              <td>
                <?php if ($this->_tpl_vars['item']['status'] == 3): ?>
                  <span data-url='<?php echo ((is_array($_tmp="batches/batches_edit")) ? $this->_run_mod_handler('site_url', true, $_tmp) : site_url($_tmp)); ?>
' data-id='<?php echo $this->_tpl_vars['item']['id']; ?>
' batches-name='<?php echo $this->_tpl_vars['item']['batches_name']; ?>
' data-airport='<?php echo $this->_tpl_vars['item']['airport']; ?>
' flight-date='<?php echo $this->_tpl_vars['item']['flight_date']; ?>
' flight-num='<?php echo $this->_tpl_vars['item']['flight_num']; ?>
' pallet-no='<?php echo $this->_tpl_vars['item']['pallet_no']; ?>
' class="modify_popup btn green mini"><i class="icon-edit"></i> 编辑</span>
                <?php else: ?>
                  <span class="btn black mini"><i class="icon-edit"></i> 编辑</span>
                <?php endif; ?>
              </td>
