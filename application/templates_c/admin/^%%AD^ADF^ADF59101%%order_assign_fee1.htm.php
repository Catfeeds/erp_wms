<?php /* Smarty version 2.6.20, created on 2017-05-19 09:47:54
         compiled from order_assign_fee1.htm */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'site_url', 'order_assign_fee1.htm', 78, false),)), $this); ?>
            ...
            <div class="form">
                ...
                <form action="" id="form_logis" class="form-horizontal" method="post" >
                    <table class="table table-bordered table-hover dataTable" id="table_1">
                        ...
                        <thead>
                        <tr>
                            <th bgcolor="#E2EEFE" colspan="99">是否指定实际运费</th>
                        </tr>
                        <tr>
                            <td>
                                ...
                                <div class="row-fluid" style="margin-top: 10px">
                                    <label  class="control-label">指定实际运费</label>
                                    <div class="controls span3">
                                        <input type="text" name="assign_cost_fee" value="<?php echo $this->_tpl_vars['re']['assign_cost_fee']; ?>
" \>
                                    </div>
                                </div>
                                <div class="row-fluid" style="margin-top: 10px">
