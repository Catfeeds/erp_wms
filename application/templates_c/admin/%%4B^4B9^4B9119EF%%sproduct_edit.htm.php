<?php /* Smarty version 2.6.20, created on 2017-03-24 16:04:23
         compiled from D:%5Cphpstudy%5CWWW%5Cerp_wms%5Capplication%5Ctemplates/admin/sproduct_edit.htm */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'escape', 'D:\\phpstudy\\WWW\\erp_wms\\application\\templates/admin/sproduct_edit.htm', 111, false),array('modifier', 'site_url', 'D:\\phpstudy\\WWW\\erp_wms\\application\\templates/admin/sproduct_edit.htm', 320, false),)), $this); ?>
...
&act_ajax=1",form1.serialize(),function(msg){
        ...
        $("#submit_product_add").click(function(){
            if(form1.valid()==true)
            {
                ...
                $.post('<?php echo ((is_array($_tmp="product/product_add_or_edit")) ? $this->_run_mod_handler('site_url', true, $_tmp) : site_url($_tmp)); ?>
