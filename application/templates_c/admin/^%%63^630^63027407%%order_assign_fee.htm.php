<?php /* Smarty version 2.6.20, created on 2017-05-19 09:47:54
         compiled from order_assign_fee.htm */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'site_url', 'order_assign_fee.htm', 78, false),)), $this); ?>
                        ...
                        <tr>
                            <td>
                                ...
                                <div class="row-fluid" style="margin-top: 10px">
                                    ...
                                    <div class="controls span3">
                                        <input type="text" name="assign_fee" value="<?php echo $this->_tpl_vars['re']['assign_fee']; ?>
" \>
                                    </div>
                                </div>
                                <div class="row-fluid" style="margin-top: 10px">
